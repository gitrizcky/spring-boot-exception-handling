...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        return buildResponseEntity(new ApiError(error, ex), BAD_REQUEST);
    }
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        return buildResponseEntity(new ApiError(builder.substring(0, builder.length() - 2), ex), HttpStatus.UNSUPPORTED_MEDIA_TYPE);
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotWritable(HttpMessageNotWritableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return buildResponseEntity(new ApiError(error, ex), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
        ...
        if (ex.getCause() instanceof ConstraintViolationException) {
            return buildResponseEntity(new ApiError("Database error", ex.getCause()), HttpStatus.CONFLICT);
        }
        return buildResponseEntity(new ApiError(ex), HttpStatus.INTERNAL_SERVER_ERROR);
    }
